...
city = 'Delhi'
api_key = '88f5243eb8dcfc51cbb2a42afada22c7'
...
while True:
    ...
    cur.execute("INSERT INTO delhi_temperature (timestamp, temperature, temperature_feels, pressure, humidity, wind_speed, wind_direction, visibility, cloudiness) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
